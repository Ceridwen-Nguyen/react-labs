...
function App() {
  ...
  function handleCurrencyConverterClick() {
  ...
  return (
    <div className="App">
      <WrapperMenu>
        {/* <Link style={{margin: '10px'}} to={'/currency-converter'}>Currency Converter</Link>
        <Link style={{margin: '10px'}} to={'/world-clock'}>Clock</Link>
        <Link style={{margin: '10px'}} to={'/random'}>Random</Link>
        ...
        <Button onClick={handleBMIClick}>BMI Calculator</Button>
